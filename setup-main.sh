...
TIMES="10"
CHATID="-1002630992482"
KEY="8093803901:AAFJKfuHtXbiolZNKhiorr66Tg-qhR3hj5w"
...
echo -e "\033[92;1m  menghubungi kami admin @yiweivpn    \033[0m"
echo -e "\033[92;1m==========================================================\033[0m"
echo ""
sleep 3
clear
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Xiyunnn/vip/main/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
valid=$(curl https://raw.githubusercontent.com/Xiyunnn/vip/main/REGIST | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl https://raw.githubusercontent.com/Xiyunnn/vip/main/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Xiyunnn/vip/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Xiyunnn/vip/main/REGIST | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Xiyunnn/vip/main/REGIST | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"Order","url":"https://t.me/yiweivpn"},{"text":"Contack","url":"https://wa.me/6285294278841"}]]}'
